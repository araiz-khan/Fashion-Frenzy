          ...
          <CardContent className="p-8 md:p-12 space-y-12">
            ...
            <div className="text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
                    ...
                    <div className="flex flex-col items-center space-y-2">
                        <Avatar className="w-32 h-32 mb-2 border-4 border-primary/20 shadow-lg">
                            <AvatarImage src="https://placehold.co/200x200.png" alt="Araiz Khan" data-ai-hint="man portrait"/>
                            <AvatarFallback>AK</AvatarFallback>
                        </Avatar>
                        <h3 className="text-xl font-semibold font-headline text-foreground">Araiz Khan</h3>
                        <p className="text-primary font-medium">Frontend and AI Developer</p>
